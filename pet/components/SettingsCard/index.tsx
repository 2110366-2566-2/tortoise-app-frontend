...
export default function SettingsCard(props: IPetDetail) {
    const rows: GridRowsProp = [
        { id: 1, col1: 'Name:', col2: props.name },
    ...
    return (
        ...
        <Box sx={{ height: 'auto', width: '100%', boxShadow: '6px 6px #472F05' }}>
            <Box sx={{ height: 'auto', width: '100%', paddingLeft: 3, paddingY: 1, fontSize: 30, backgroundColor: '#F9C067', 
            border: '2px solid #472F05'}}>
                {props.name}
            </Box>
            <DataGrid rows={rows} columns={columns} hideFooter={true} columnHeaderHeight={0} 
