        ...
        <Box sx={{width: '100vw', height:'100vh'}}>
            <TopBarHomepage />
                <Box sx={{display: 'flex', flexDirection: 'row', height: '85%', width: '100vw'}}>
                    <Box sx={{width: '56%', backgroundColor: '#F3DDD1', display: 'flex', flexDirection: 'column',
                    alignItems: 'center', justifyContent: 'space-around', paddingX: 15}}>
